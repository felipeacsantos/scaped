...
class TestesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testis" do
    assert_difference('Teste.count') do
      post testes_url, params: { testis: { checkexists: @testis.checkexists, checkvalor: @testis.checkvalor, criterio_id: @testis.criterio_id, objeto_id: @testis.objeto_id, texto: @testis.texto, versao: @testis.versao } }
    end
  ...
  test "should update testis" do
    patch testis_url(@testis), params: { testis: { checkexists: @testis.checkexists, checkvalor: @testis.checkvalor, criterio_id: @testis.criterio_id, objeto_id: @testis.objeto_id, texto: @testis.texto, versao: @testis.versao } }
