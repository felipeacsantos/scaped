...
class ParametrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post parametros_url, params: { parametro: { name: @parametro.name, value: @parametro.value } }
    end
  ...
  test "should update parametro" do
    patch parametro_url(@parametro), params: { parametro: { name: @parametro.name, value: @parametro.value } }
